...
//
//     const errors = {};
//     const arrIp = inputs.ipAddress.split(".");
//     if (!inputs.ipAddress) {
//         errors.ipAddress = 'Empty field!';
//     } else if (inputs.ipAddress.split(".").length !== 4) return errors.ipAddress = 'Invalid IP address!';
//     for (let oct of arrIp) {
//         if ( isNaN(oct) || Number(oct) < 0 || Number(oct) > 255)
//             return errors.ipAddress = 'Invalid IP address!';
//     }
//     return errors;
// }

// let  isValid =(value,text,er)=> {
//     let arrValue = value.split(".");
//     if (arrValue.length !== 4) {
//         er = `Invalid ${text}`
//     }
//     for (let oct of arrValue) {
//         if ( isNaN(oct) || Number(oct) < 0 || Number(oct) > 255)
//             er = "Invalid IP";
//     }
// }

// let isValid =(fieldName,text)=> {
//     let arrFieldName = values.fieldName.split(".");
//     if (arrFieldName.length !== 4) {
//         errors.fieldName = `Invalid ${text}!`
//     }
//     for (let oct of arrFieldName) {
//         if (isNaN(oct) || Number(oct) < 0 || Number(oct) > 255) {
//             errors.fieldName = `Invalid ${text}!`;
//         }
//     }
